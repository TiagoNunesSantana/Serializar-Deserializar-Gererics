...
namespace _01_Generics
{
    public class Serializador
    {
        ...
        {
            StreamWriter sw = new StreamWriter(@"C:\Projetos\Topicos Avancados\Aquivos\03_"+obj.GetType().Name+".txt");
        ...
        {
            StreamReader sr = new StreamReader(@"C:\Projetos\Topicos Avancados\Aquivos\03_"+typeof(T).Name+".txt");
